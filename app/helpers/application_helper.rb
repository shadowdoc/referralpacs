...
module ApplicationHelper
  ...
  def set_current_patient_banner
    ...
    unless @patient.nil? || @patient.full_name.nil?
      @current_patient_banner = link_to(@patient.full_name, :controller => :encounter, :action => :find, :id => @patient.id) + " | AMPATH ID: " + @patient.mrn_ampath.to_s  + " | MTRH Rad ID: " + @patient.mtrh_rad_id.to_s + " | Current Age: " + @patient.current_age.to_s + " | OpenMRS Verified: " + @patient.openmrs_verified.to_s
    end
